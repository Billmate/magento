 ...
 *
 * @category    Mage
 * @package     Mage_Billmate
 * @copyright   Copyright (c) 2012 Magento Inc. (http://www.magentocommerce.com)
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

/**
 * Abstract class for Billmate API wrappers
 *
 * @author      Magento Core Team <core@magentocommerce.com>
 */
abstract class Billmate_Bankpay_Model_Api_Abstract extends Varien_Object
{
    /**
     * Config instance
     * @var Mage_Billmate_Model_Config
     */
    ...
    /**
     * Billmate shopping cart instance
     *
     * @var Billmate_Cardpay_Model_Cart
     */
   ...
   /**
    ...
    /**
     * Return Billmate Api user name based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Billmate Api password based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Billmate Api signature based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Billmate Api certificate based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Billmate Api proxy status based on config data
     *
     * @return bool
     */
    ...
    /**
     * Return Billmate Api proxy host based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Billmate Api proxy port based on config data
     *
     * @return string
     */
    ...
    /**
     * Billmate page header image URL getter
     *
     * @return string
     */
    public function getHdrimg()
    {
        return $this->_getDataOrConfig('billmate_hdrimg');
    }

    /**
     * Billmate page header border color getter
     *
     * @return string
     */
    public function getHdrbordercolor()
    {
        return $this->_getDataOrConfig('billmate_hdrbordercolor');
    }

    /**
     * Billmate page header background color getter
     *
     * @return string
     */
    public function getHdrbackcolor()
    {
        return $this->_getDataOrConfig('billmate_hdrbackcolor');
    }

    /**
     * Billmate page "payflow color" (?) getter
     *
     * @return string
     */
    public function getPayflowcolor()
    {
        return $this->_getDataOrConfig('billmate_payflowcolor');
    }
    ...
    /**
     * Billmate merchant email getter
     */
     ...
     * @param Mage_Billmate_Model_Config $config
     * @return Mage_Billmate_Model_Api_Abstract
     */
    public function setConfigObject(Billmate_Cardpay_Model_Config $config)
    {
        $this->_config = $config;
        return $this;
    }
    ...
    /**
     * region_id workaround: Billmate requires state code, try to find one in the address
     *
     ...
     * Billmate note: The value for quantity must be a positive integer. Null, zero, or negative numbers are not allowed.
     *
