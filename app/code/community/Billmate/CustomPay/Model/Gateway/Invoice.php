...
class Billmate_CustomPay_Model_Gateway_Invoice extends Billmate_CustomPay_Model_Gateway
{
    const METHOD_CODE = 1;

    const METHOD_NAME = 'bmcustom_invoice';
    ...
    public function makePayment()
    {
        ...
        $orderValues['Customer']['pno'] =
            (empty($payment[Billmate_CustomPay_Block_Invoice_Form::PNO_INPUT_CODE])) ? $payment['person_number'] : $payment[Billmate_CustomPay_Block_Invoice_Form::PNO_INPUT_CODE];
        ...
        if ($payment['method'] == self::METHOD_NAME) {
            ...
            switch ($result['code']) {
                ...
                case 2405:
                    ...
                    if (Mage::getStoreConfig('firecheckout/general/enabled')) {
                        $this->getOnepage()->getCheckout()->setUpdateSection('sagepay-iframe');
                    } else {
                        $this->getOnepage()->getCheckout()->setUpdateSection('billmate');
                    }
