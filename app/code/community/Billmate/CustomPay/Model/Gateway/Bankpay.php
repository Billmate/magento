<?php
class Billmate_CustomPay_Model_Gateway_Bankpay extends Billmate_CustomPay_Model_Gateway
{
    ...
    protected function getCardUrls()
    {
        $quote = $this->getQuote();
        return [
            'accepturl' => Mage::getUrl('custompay/bankpay/accept',array('billmate_quote_id' => $quote->getId(),'_secure' => true)),
            'cancelurl' => Mage::getUrl('custompay/bankpay/cancel',array('_secure' => true)),
            'callbackurl' => Mage::getUrl('custompay/bankpay/callback',array('billmate_quote_id' => $quote->getId(),'_secure' => true)),
