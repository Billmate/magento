...
class Billmate_BillmateCheckout_Model_Gateway extends Billmate_Common_Model_Payment_GatewayCore
{
    const METHOD_CODE = 1;

    const METHOD_NAME = 'billmatecheckout';
    ...
    public function makePayment()
    {
        ...
        $methodName = $payment['method'] == 'billmatecheckout' ? 'billmatecheckout' : 'billmatepartpayment';
        ...
        if (isset( $result['code'] )) {
            switch ($result['code']) {
                ...
                case 2405:
                    $this->init();
                    echo Mage::app()->getLayout()->createBlock('billmatecheckout/changeaddress')->toHtml();
                    die();
                    break;
                default:
            ...
            $session->setData( 'billmatecheckout_id', $result['number'] );
