...
class Billmate_BillmateCheckout_Model_Quote_Total extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    ...
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        if ($this->paymentMethod->getCode() === 'billmatecheckout') {
    ...
    {
        $fee = Mage::getStoreConfig('payment/billmatecheckout/billmate_fee', Mage::app()->getStore()->getId());

		$fee = Mage::helper('billmatecheckout')->replaceSeparator($fee);
    ...
    public function fetch(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        $data = Mage::helper("billmatecheckout");
        ...
        $address->addTotal(
            array(
                'code' => $this->getCode(),
                'title' => Mage::helper('payment')->__('Billmate Сheckout Fee'),
                'value' => $incl
            )
        );
        return $this;
