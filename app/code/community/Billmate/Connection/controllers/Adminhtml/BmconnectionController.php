...
class Billmate_Connection_Adminhtml_BmconnectionController extends Mage_Adminhtml_Controller_Action
{
    public function verifyAction()
    {
        $eid = $this->getRequest()->getParam('eid');
        $secret = $this->getRequest()->getParam('secret');
		$status = Mage::helper('bmconnection')->verifyCredentials($eid, $secret);
