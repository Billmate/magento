...
### 3.2.4 (2019-05-23)
* Fix - Added error message in case of incorrect org/pno
* Fix - Added support to run Billmate Checkout even if Swedish is not the Default Country
* Fix - Removed code to improve traffic to Billmate server
